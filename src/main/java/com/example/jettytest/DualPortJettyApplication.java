...
public final class DualPortJettyApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Server server = createServerWithVirtualThreadPoolOnly(testingPort, testing2Port);
        try {
            server.start();
    ...
    static Server createServerWithQueuedThreadPool(int testingPort, int testing2Port) {
    ...
    static Server createServerWithVirtualThreadPoolOnly(int testingPort, int testing2Port) {
